...
def remove_include(k1: NewBar, k2: NewBar, k3: RawBar):
    """
    去除包含关系：输入三根k线，返回包含关系及新K线；K线对新数据是否存在包含关系的衍生
    :param k1: 没有包含关系的K线
    :param k2: 没有包含关系的K线
    :param k3: 原始K线
    :return:
...
class CZSC:
    ...
    def __update_bi(self):
        ...
        if envs.get_bi_change_th() > 0.5 and len(self.bi_list) >= 5:
            # 笔涨跌幅 benchmark 的判断标准
            # min(上一笔价差力度，最近5笔价差力度的均值)
